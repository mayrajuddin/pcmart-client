            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-12 h-72 gap-4 items-center">
                    <div className='col col-span-7 mx-5'>
                        ...
                        <h2 className="text-4xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa vero fugiat excepturi odio placeat aperiam explicabo. Odit pariatur at eius.</h2>
                    </div>
